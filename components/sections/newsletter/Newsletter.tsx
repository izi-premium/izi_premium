  ...
  return (
    <section className="flex-center-col px-mobile md:px-tablet lg:px-desktop xl:container-wrapper w-full gap-10 bg-white py-[8rem] lg:py-[10rem]">
      <div className="flex-center-col gap-4">
        ...
        <p className="paragraph-24-normal md:subtitle-normal text-primary-text-500 max-w-[90rem] text-center">
          {tNewsletter("text")}
        </p>
      </div>
      <Link
        href="#"
        className="hover:shadow-header bg-accent-500 relative flex items-center justify-center rounded-[0.8rem] p-1 transition-all duration-300 ease-in-out hover:scale-105 hover:cursor-pointer md:w-[38rem]"
      >
        ...
        <div className="border-elevated-surfaces-500 relative w-full rounded-[0.4rem] border border-solid px-8 py-3 xl:px-[clamp(32px,1.66vw)] xl:py-[clamp(12px,0.625vw)]">
          <p className="paragraph-18-medium md:subtitle-medium text-secondary-text-500 w-full text-center">
            {tNewsletter("cta")}
          </p>
        </div>
      </Link>
