...
const FortuneCookies = () => {
  ...
  return (
    <section className="flex-start-col xl:container-wrapper w-full px-[1.2rem] py-10 md:px-[3.2rem] lg:px-[5rem] lg:py-20">
      <div className="flex-start-col border-primary-text-200 w-full gap-[6.4rem] rounded-[2rem] border border-solid bg-white px-[1.2rem] py-10 md:px-[3.2rem] lg:px-[5rem] lg:py-20">
        ...
        <div className="flex-center-col w-full gap-10">
          <div className="bg-elevated-surfaces-500 border-primary-text-200 flex-start w-full gap-10 rounded-[1.6rem] border border-solid px-6 py-6 md:px-12 md:py-12">
        ...
        {/* Card 2 */}
        <div className="bg-elevated-surfaces-500 border-primary-text-200 flex-start w-full flex-row-reverse gap-10 rounded-[1.6rem] border border-solid px-6 py-6 md:px-12 md:py-12">
          <div className="flex-start-col w-full gap-4">
            <h3 className="paragraph-24-medium md:subtitle-medium text-primary-text-700">
              {tCookie("card2-title")}
            </h3>
