    ...
    <section className="flex-center-col px-mobile md:px-tablet lg:px-desktop xl:container-wrapper w-full justify-between gap-[6.4rem] py-[8rem] lg:flex-row lg:justify-between lg:py-[10rem]">
      <div className="flex w-full flex-col items-start justify-start gap-10 py-10">
        ...
        <div className="flex w-full flex-col items-center justify-start gap-4 md:items-start">
          ...
          >
            <span className="bg-primary-action-100 absolute right-[63px] bottom-[-17px] h-[5rem] w-[12rem] rounded-full blur-[70px] xl:h-[clamp(5rem,2.6vw,9rem)] xl:w-[clamp(12rem,6.25vw,20rem)]"></span>
            <span className="bg-primary-action-100 absolute bottom-[-26px] left-[52px] h-[5rem] w-[12rem] rounded-full blur-[70px] xl:h-[clamp(5rem,2.6vw,9rem)] xl:w-[clamp(12rem,6.25vw,20rem)]"></span>
