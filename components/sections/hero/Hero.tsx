...
const Hero = () => {
  ...
  return (
    <section className="flex-center-col bg-white-300 px-mobile md:px-tablet lg:px-desktop w-full justify-between gap-[6.4rem] py-[8rem] lg:flex-row lg:justify-between lg:py-[10rem]">
