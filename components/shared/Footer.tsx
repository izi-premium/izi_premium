          ...
          <div className="flex-begin-col gap-20 lg:flex-row lg:justify-between">
            <div className="flex-begin-col gap-8">
              ...
              <div className="flex-begin-col gap-2">
                ...
                <Link
                  href="#"
                  className="hover:shadow-header bg-accent-500 relative flex items-center justify-center rounded-[0.8rem] p-1 transition-all duration-300 ease-in-out hover:scale-105 hover:cursor-pointer md:w-[30rem]"
                >
