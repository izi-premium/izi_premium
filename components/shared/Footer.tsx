...
export default function Footer() {
  ...
  return (
    <footer className="flex-center w-full bg-white">
      <div className="px-mobile md:px-tablet lg:px-desktop flex-center-col bg-elevated-surfaces-500 border-primary-text-200 w-full gap-10 rounded-t-[3.2rem] border-t border-r border-l border-solid py-10 lg:gap-6">
